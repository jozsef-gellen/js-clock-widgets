...
function updateClock() {
  ...
  setDigitInverted(document.getElementById('h1'), h[0]);
  setDigitInverted(document.getElementById('h2'), h[1]);
  setDigitInverted(document.getElementById('m1'), m[0]);
  setDigitInverted(document.getElementById('m2'), m[1]);
  setDigitInverted(document.getElementById('s1'), s[0]);
  setDigitInverted(document.getElementById('s2'), s[1]);
}
